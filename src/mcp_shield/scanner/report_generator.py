...
<div class="footer">
  Generated by <strong>mcp-shield v0.1.0</strong> &mdash; <a href="https://github.com/mcp-shield/mcp-shield">github.com/mcp-shield/mcp-shield</a>
...
def generate_text_report(report: SecurityReport) -> str:
    ...
    lines.append("")
    lines.append("=" * 70)
    lines.append("  Generated by mcp-shield v0.1.0")
    lines.append("=" * 70)
    return "\n".join(lines)
